...
class GalleriesControllerTest < ActionController::TestCase
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post :create, gallery: { category_id: @gallery.category_id, description: @gallery.description, name: @gallery.name, product_id: @gallery.product_id }
    end
  ...
  test "should update gallery" do
    patch :update, id: @gallery, gallery: { category_id: @gallery.category_id, description: @gallery.description, name: @gallery.name, product_id: @gallery.product_id }
    assert_redirected_to gallery_path(assigns(:gallery))
  end
